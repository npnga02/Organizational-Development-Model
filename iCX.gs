...
var startDate = "2023/01/01" //Utilities.formatDate(new Date(today), "GMT+7", "dd/MM/yyyy"); //YYYY/MM/DD
var endDate = today
...
function convertDatesToShortFormat2(nameSheet) {
  ...
  var range = sheet.getRange("M2:T" + sheet.getLastRow()); // Adjust range as per your column indices
    ...
    for (var i = 0; i<allApplications.length; i++) {
      ...
      try {
        var row = [
          ...
          application['opportunity'] ? application['opportunity']['opportunity_duration_type'] ? application['opportunity']['opportunity_duration_type']['duration_type'] : '' : '',
          ...
          application['opportunity'] ? application['opportunity']['organisation'] ? application['opportunity']['organisation']['name'] : '' : '',
          application['opportunity'] ? application['opportunity']['logistics_info'] ? application['opportunity']['logistics_info']['no_of_meals'] : '' : '',
          application['opportunity'] ? application['opportunity']['project_fee'] : '',          
          '',
          application['opportunity'] ? application['opportunity']['logistics_info'] ? application['opportunity']['logistics_info']['accommodation_covered'] : '' : '',
          application['opportunity'] ? application['opportunity']['logistics_info'] ? application['opportunity']['logistics_info']['accommodation_provided'] : '' : ''
        ];
        rows.push(row);
      }
      catch (error) {
